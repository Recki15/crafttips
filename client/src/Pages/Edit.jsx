...
export const Edit = () => {
  ...
  const viewPostById = async (a, b) => {
    try {
      await axios
        .get(`http://localhost:5000/findPostById/${ids}`)
        .then((res) => {
          if (b < 1) {
  ...
  const ondescription = (value) => {
    setuserInfo({ ...userInfo, long_desc: value });
  };
            ...
            <form onSubmit={addDetails} className="update__forms">
              <div className="form-row">
                ...
                <div>
                  ...
                  <p>
                    LINK the image you want to use as a cover for your post.
                    Leaving empty equals using the sample image.
                  </p>
                  <input
                    type="text"
                    name="cover_image"
                ...
                <div>
                  ...
                  <p>
                    Please write a short description for your CraftTip. Just
                    tell the basic capabilities of your tip and what it can be
                    used for. (Maximum 150 letter)
                  </p>
                  <textarea
                    rows="4"
                    cols={50}
                    maxLength={150}
                    value={userInfo.short_desc}
                    onChange={onChangeValue}
                    name="short_desc"
                    className="form-content"
                  />
                ...
                <div className="form-group col-md-12 editor">
                  ...
                  <label className="font-weight-bold">
                    {" "}
                    Long Description <span className="required"> * </span>{" "}
                  </label>
                  <p>
                    This is the main part where you can tell instructions,
                    upload images for guidance or link in video for your tip.
                    The limis is only your imagination, try to be as creative as
                    you can! :)
                  </p>
                ...
                <div>
                  ...
                  <label className="font-weight-bold">
                    {" "}
                    Tools <span className="required"> * </span>{" "}
                  </label>
                  <p>
                    Select the tools needed for this project from this dropdown
                    menu. You can select multiple one, and also search for the
                  ...
                  <h1 style={{ color: "red" }}>
                    Warning! You should re-select the tools you need for this
                    tip!
                  </h1>
                </div>
